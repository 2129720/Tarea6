...
plot(x, cdf, type = "l", main = "CDF (n = 10, p = 1/2)", xlab = "x", ylab = "Probabilidad acomulada")
```
...
plot(x, cdf, type = "l", main = "CDF (n = 10, p = 1/8)", xlab = "x", ylab = "Probabilidad acomulada")
```
...
plot(x, cdf, type = "l", main = "CDF (n = 10, p = 4/5)", xlab = "x", ylab = "Probabilidad acomulada")
```
...
plot(x, y, type = "l", col = "red", lwd = 2, xlab = "x", ylab = "f_X(x)", main = "PDF - Densidad Triangular (a=0, c=4, b=2)")
grid()
...
plot(x, y, type = "l", col = "red", lwd = 2, xlab = "x", ylab = "f_X(x)", main = "PDF - Densidad Triangular (a=1, c=2, b=4)")
grid()
...
plot(x, y, type = "l", col = "red", lwd = 2, xlab = "x", ylab = "f_X(x)", main = "PDF - Densidad Triangular (a=-1, c=0, b=1)")
grid()
...
# Graficar la función f_X(3-x)
plot(x, y, type = "l", col = "red", xlab = "x", ylab = "f_X(3-x)",
     main = "Gráfico de f_X(3-x)")
```
